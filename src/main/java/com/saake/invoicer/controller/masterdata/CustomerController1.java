...
@ManagedBean(name = "customerController1")
@ViewScoped
public class CustomerController1 implements Serializable {
...
//    }
    ...
    public static class CustomerControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            CustomerController1 controller = (CustomerController1) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "customerController1");
